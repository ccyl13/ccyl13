...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Metasploit-5e5c5c?style=for-the-badge&logo=metasploit&logoColor=white"/>
  ...
  <img src="https://img.shields.io/badge/Wordlists%20%2F%20Payloads-3498db?style=for-the-badge"/>
...
### 🛠️ Herramientas de Red Team que utilizo

- 🧠 **Empire** – Post-explotación avanzada
- 📡 **Cobalt Strike** – Simulación de ataques persistentes
- 🔍 **BloodHound** – Enumeración de dominios AD
- 🪛 **CrackMapExec** – Hacking en redes Windows
- 🎯 **Impacket** – Explotación de protocolos y redes
- 🐍 **Python scripts personalizados** – Automatización ofensiva

---

### 🕵️‍♂️ Ingeniería Social & OSINT

- 📱 PhoneInfoga, Sherlock, IntelX, UserSearch
- 💬 Social-Engineer Toolkit (SET)
- ✉️ Phishing framework y plantillas simuladas
- 🧩 Extracción de metadatos, fingerprinting de usuarios
- 🕸️ Búsqueda profunda en redes y dark web
